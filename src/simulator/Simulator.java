...
public class Simulator extends Group
{
    ...
    /**
     * this sets up the forces when simulator is ran setting their initial values
     *
     * @param primaryStage This is the main window
     */
    ...
    /**
     * when called it populates the screen with actors
     */
    ...
    public void save()
    {
        ...
        {
            this.forcesOfLight.serialize(
                    out); // "normal" method call that I created. Army class NOT serializable.
    ...
    public void restore()
    {
        ...
        {
            this.forcesOfLight.deserialize(
                    in); // "normal" method call that I created. Army class NOT serializable.
    ...
    { // final because of its use in
        ...
        vBoxLightArmy.setAlignment(Pos.CENTER);
        ...
        vBoxDarkArmy.setAlignment(Pos.CENTER);
        ...
        this.stageListControllerWindow.setResizable(false);
    ...
    { // final because of its use in
        // the constructor
        final double PREF_WIDTH = 520.0;
        final double PREF_HEIGHT = 450.0;
        VBox vBoxLightArmy =
                new VBox(
                        10.0,
                        new Text(this.forcesOfLight.getName()),
        ...
        VBox vBoxDarkArmy =
                new VBox(
                        10.0,
                        new Text(this.forcesOfDarkness.getName()),
        ...
        this.stageTableControllerWindow.setTitle("Army Tables");
        this.stageTableControllerWindow.setResizable(false);
